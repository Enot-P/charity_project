...
class FondData {
  ...
  static List<FondData> fondList = <FondData>[
    FondData(
      ...
      description: 'Фонд "Доброе сердце" создан для помощи людям, оказавшимся в трудной жизненной ситуации. Мы стремимся улучшить их жизнь, предоставляя материальную поддержку, '
          'социальные услуги и психологическую помощь.',
    ...
    FondData(
      ...
      amount: '525',
      tag: 'Здравоохранение',
      description: 'Фонд "Доброе сердце" создан для помощи людям, оказавшимся в трудной жизненной ситуации. Мы стремимся улучшить их жизнь, '
          'предоставляя материальную поддержку, социальные услуги и психологическую помощь.',
      contactInfo: 'Телефон: 8-800-555-35-35 \nАдрес: г.Москва, ул.Ленина, д.10 \nE-mail: 6xqg5@example.com',
    ),
    FondData(
      id: 2,
